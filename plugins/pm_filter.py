...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url='https://t.me/+hC5tRAvQHHplMWQ1'),
            InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='https://t.me/+L8SWfrF_7m04ODZl')
            ],[      
            InlineKeyboardButton('ʜᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('ᴀʙᴏᴜᴛ', callback_data='about')
            ],[
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/+L8SWfrF_7m04ODZl')
        ]]         
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ℹ️sᴏᴜʀᴄᴇ', callback_data='source')
        ], [
            InlineKeyboardButton('🏡ʜᴏᴍᴇ', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://graph.org/file/b1da50f7fa8f23c6e8eb1.jpg'),
